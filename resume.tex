...
{\noindent\small\textbf{Languages:} \newline
Languages that I have used previously
...
{\noindent\small\textbf{Tools:} 
\begin{itemize}\setlength{\itemsep}{-1pt}
    \item Vim
    \item Git
    \item Command Line (Linux/Mac)
    \item Bash
    \item Docker
    \item Kubernetes
    \item Apache
...
\noindent\large{\scshape{Current Job}} \newline
\noindent{\rule[0.3cm]{\textwidth}{0.4pt}}
\noindent\resumeSubheading{Boogies}{}{Cleaner}{Sep. 2018 -- Present}
